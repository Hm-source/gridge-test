...
public enum LogType {
    ...
    USER_LOGOUT("회원 로그아웃"),
    USER_SIGNUP("회원 가입"),
    USER_OAUTH_SIGNUP("OAUTH 회원가입"),
    USER_UPDATE("회원 정보 수정"),
    USER_DELETE("회원 탈퇴"),
    USER_PASSWORD_CHANGE_REQUEST("비밀번호 변경 요청"),
    USER_PASSWORD_CHANGE("비밀번호 변경"),
    USER_AUTH_REFRESH("refresh token 발급"),
    USER_TERMS_VIEW("사용자 이용약관 조회"),
    USER_VERIFY("사용자 코드 검증"),
    USER_VERIFY_RESEND("사용자 검증 코드 재요청"),
    ...
    FEED_VIEW("피드 조회"),
    FEED_LIKE_VIEW("피드 좋아요 조회"),
    FEED_LIKE_USERS_VIEW("피드 좋아요 사용자 조회"),
